...
export async function buildNextJsProject(
  ...
  const projectDir = path.join(os.tmpdir(), `webechoai-clone-${taskId}`);
...
export const metadata: Metadata = {
  title: 'Cloned Site',
  description: 'Generated by WebEcho AI',
};
...
`;
  ...
  const zipPath = path.join(os.tmpdir(), `webechoai-clone-${taskId}.zip`);
